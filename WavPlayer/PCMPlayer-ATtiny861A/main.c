...
!!!REMOVED FROM SOURCECODE, ADDED TO MAKEFILE!!!
...
Changes: Low Fuse: 16Mhz internal oszillator, change startup time to work with BOD
		 High Fuse: BOD-Level around 2.7V, BOD active
		 Extended Fuse: no changes, default value*/

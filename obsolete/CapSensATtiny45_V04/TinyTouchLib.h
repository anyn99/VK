...
#define touch_threshold_on 10
#define touch_threshold_off 8
...
#define tt_sensepin 4	// Use PB4 as sense pin
#define tt_senseadc 2	// Use ADC2 as sense ADC input
